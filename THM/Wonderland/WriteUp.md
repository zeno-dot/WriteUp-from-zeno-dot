...
При этом в самой директории ничего особенного не написано. Решил полностью перечитать весь текст и найти подсказку. И, судя по тексту, нужно найти кролика? Проверка на директорию /rbbit ничего не дала, в ходе перебора вариантов был найден такой вектор.
